...
- [0327](https://leetcode.cn/problems/convert-bst-to-greater-tree/?favorite=2cktkvj) *538. 把二叉搜索树转换为累加树*  本题首先需要理解累加树的属性，累加树每一个节点的值在二叉搜索树中，可以直接表示为通过**右-中-左**进行递归遍历即可。